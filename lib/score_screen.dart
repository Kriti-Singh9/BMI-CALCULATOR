...
class ScoreScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    children: [
      ...
      maxValue: 40,
      segments: [
        GaugeSegment('UnderWeight', 18.5, Colors.redAccent),
        GaugeSegment('Normal', 6.4, Colors.greenAccent),
        GaugeSegment('OverWeight', 5, Colors.orangeAccent),
        GaugeSegment('Obese', 10.1, Colors.pinkAccent),
      ],
  ...
  void setBmiInterpretation(){
    if(bmiScore > 30){
      ...
      bmiStatusColor = Colors.greenAccent;
    }else if(bmiScore < 18.5){
